...
public class TheaterController {
	...
	public ResponseEntity<ApiResponse<Page<TheaterResponse>>> getAllTheaters(
			...
			@RequestParam(name = "location", required = false) String location, Pageable pageable) {
	...
	public ResponseEntity<ApiResponse<TheaterResponse>> getTheaterById(@PathVariable("theaterId") Long theaterId) {
		try {
	...
	// 특정 극장의 상영 정보 조회
	@GetMapping("/{theaterId}/schedules")
	...
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<ApiResponse<TheaterResponse>> uploadTheaterImage(@PathVariable Long id,
